...
const { update: updateValidator } = require("../validators/profile");
...
router.route("/profile/image").post(authMiddleware, checkUserById, upload.single("image"), userController.uploadProfileImage);
